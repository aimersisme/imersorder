...
## Yang baru
- Hutang & Piutang standalone dengan cicilan dan sisa saldo.
...
### Brand + tagline
Brand header sekarang menggunakan logo iMersOrder transparan tanpa kotak/frame dan menampilkan tagline:
...
Untuk database project iMersOrder yang sudah memakai patch v0.2.1+, jalankan:

`iMersOrder_v0.2.8_DASHBOARD_PERSONALIZATION_PATCH.sql`
...
## v1.0.0-r12 — Single Install + Reminder
...
- Pembayaran/cicilan dengan RPC yang mengunci saldo untuk mencegah pembayaran melebihi sisa.
...
- Master schema fresh-install: `iMersOrder_MASTER_FULL_v1.6.sql`.
